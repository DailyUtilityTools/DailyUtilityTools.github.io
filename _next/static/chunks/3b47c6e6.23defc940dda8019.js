...
`)}
        }`},getRunData:()=>({outputs:[{dims:l,dataType:s}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:[{type:12,data:m},...tT(d,l)]})}},t5=(t,r)=>{let i=[];return t[1].dims[0]>0&&t[1].getBigInt64Array().forEach(t=>i.push(Number(t))),tv({axes:i,keepDims:r.keepDims,noopWithEmptyAxes:r.noopWithEmptyAxes})},t9=(t,r,i,a)=>{let n=t.inputs,s=1===n.length?i:t5(n,i);t.compute(t8(r,{hint:s.cacheKey,inputDependencies:["rank"]},[n[0]],s.noopWithEmptyAxes&&0===s.axes.length?t6:a,s.axes,n[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},t7=(t,r,i)=>{if(0===r.length)return i;let a=1,n=1;for(let i=0;i<r.length;i++)-1===r.indexOf(i)?a*=t[i]:n*=t[i];return n<32&&a>1024},re=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceMean",a,(t,r,a)=>{let n=1;for(let r=0;r<t.rank;r++)(a.indexOf(r)>=0||0===a.length)&&(n*=i.inputs[0].dims[r]);return["var sum = f32(0);","",`sum += f32(${t.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${n});`]})):tK(t,r)},rt=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceL1",a,(t,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${t.getByIndices("input_indices")});`,""])):tZ(t,r)},rr=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceL2",a,(t,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])):tQ(t,r)},ri=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceLogSumExp",a,(t,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${t.getByIndices("input_indices")});`,"value = log(value);"])):tX(t,r)},ra=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceMax",a,(t,r,i)=>{let a=[];for(let r=0;r<t.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(t.indicesSet("input_indices",r,0));return[`${a.join(`
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = max(value, ${t.getByIndices("input_indices")});`,""]})):tY(t,r)},rn=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceMin",a,(t,r,i)=>{let a=[];for(let r=0;r<t.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(`input_indices[${r}] = 0;`);return[`${a.join(`
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})):tJ(t,r)},rs=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceProd",a,(t,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])):t0(t,r)},ro=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceSum",a,(t,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])):t2(t,r)},ru=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceSumSquare",a,(t,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])):t1(t,r)},rl=(t,r)=>{var i,a;t7(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?(i=t,a=r,t4(i.inputs),t9(i,"ReduceLogSum",a,(t,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,"value = log(value);"])):t3(t,r)}}),nz=W(()=>{ng(),nk(),nC(),rd=t=>{if(!t||0===t.length||t.length>2)throw Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(1!==t[0].dataType)throw Error("Invalid input type.")},rp=(t,r)=>{rd(t.inputs),t.compute(t8("ArgMin",{hint:r.cacheKey,inputDependencies:["rank"]},[t.inputs[0]],(t,i,a)=>{let n=[];for(let r=0;r<t.rank;r++)(a.indexOf(r)>=0||0===a.length)&&n.push(`input_indices[${r}] = 0;`);return[`${n.join(`
...
`),r.cacheKey,t.inputs[0].dataType))}}),nN=W(()=>{nb(),nT(),nB(),r5=t=>{var r;let i,a,n,s,o,u;(t=>{if(3!==t[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(t[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==t[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(t[0].dims[2]!==t[1].dims[0])throw Error("last dimension of input and bias are not the same")})(t.inputs),t.compute(((i=(r=t.inputs)[0].dims.slice())[2]=i[2]/2,a=tR("input",r[0].dataType,r[0].dims,4),n=tR("bias",r[0].dataType,[r[0].dims[2]],4),s=tB("output",r[0].dataType,i,4),o=e4.size(i)/4,u=tS(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${s.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${y}
      }`})(t,u,l,p,h,d,f,n,i.dataType,a.dataType,o,s),getRunData:()=>({outputs:[{dims:p,dataType:o}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(e4.size(p)/4)},...tT(u,l,p)]})}})(r,n??"",t.inputs[0],t.inputs[1],i,a,s))},r7=t=>{r9(t,"Add",(t,r)=>`${t}+${r}`)},ie=t=>{r9(t,"Div",(t,r)=>`${t}/${r}`)},it=t=>{r9(t,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},ir=t=>{r9(t,"Mul",(t,r)=>`${t}*${r}`)},ii=t=>{let r=tR("input",t.inputs[0].dataType,t.inputs[0].dims).type.value;r9(t,"Pow",{scalar:(t,r)=>`pow_custom(${t},${r})`,vector:(t,r)=>`pow_vector_custom(${t},${r})`},`
...
`)})(o,c)}
        ...
        `;case"":return"";default:throw Error(`Unsupported activation ${t.activation}`)}},ih=(t,r)=>{"Clip"===t.activation?r.push({type:1,data:t.clipMax},{type:1,data:t.clipMin}):"HardSigmoid"===t.activation?r.push({type:1,data:t.alpha},{type:1,data:t.beta}):"LeakyRelu"===t.activation&&r.push({type:1,data:t.alpha})},im=(t,r)=>{"Clip"===t.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===t.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===t.activation&&r.push({name:"alpha",type:"f32"})},ig=t=>{let r=t?.activation||"";if("HardSigmoid"===r){let[i,a]=t?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=t?.activation_params||[e5,e9];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=t?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nU=W(()=>{i_=(t,r)=>{switch(t){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${t}-component is not supported.`)}},iy=t=>`
