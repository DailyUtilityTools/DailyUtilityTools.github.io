(function () {
    ...
    ; var Fb, Gb = navigator.userAgent, Hb = window.location.href, Ib = m(Gb, "iPad") || m(Gb, "iPhone") || m(Gb, "iPod"), Jb = m(Gb.toLowerCase(), "gsa"), Kb = Ib && Jb, Lb = Jb && !Ib, Mb = Ib || m(Gb, "Android") || m(Gb, "Mobile") || m(Gb, "Silk") || m(Gb, "UCBrowser") || m(Gb, "UCWEB"), Nb = 0 <= Gb.indexOf("MSIE"), Ob = m(Hb, "/logos/") && m(Hb, ".html");
    function Pb() {
