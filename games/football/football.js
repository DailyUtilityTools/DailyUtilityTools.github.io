(function () {
            ...
            if (!(b = xa[a])) {
                ...
                for (var c = ka(String(wa)).split("."), d = ka(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                    ...
                    do {
                        var q = k.exec(g) || ["", "", ""]
                            , D = t.exec(h) || ["", "", ""];
                        if (0 == q[0].length && 0 == D[0].length)
                            break;
                        b = la(0 == q[1].length ? 0 : parseInt(q[1], 10), 0 == D[1].length ? 0 : parseInt(D[1], 10)) || la(0 == q[2].length, 0 == D[2].length) || la(q[2], D[2])
                    } while (0 == b)
                }
                b = xa[a] = 0 <= b
            }
    ...
    var Ca = function (a) {
        ...
        /^http:/i.test(a) && "https:" == window.location.protocol ? delete Ba[c] : (b.src = a,
            Aa = c + 1)
    }
        , Ba = []
        , Aa = 0;
    var Da, Ea = 0 <= navigator.userAgent.indexOf("MSIE"), Ga = function (a) {
        ...
        window.WebFontConfig || (ia("WebFontConfig.google.families", a),
    ...
    Wa.prototype.v = function () {
        ...
        if (0 >= d + a + c || 0 >= e + b + c || d - c > this.T.width || e - c > this.T.height)
            return !1;
        this.B.save();
        ...
        var f = (0 > this.k ? -a : a) / 2
            ...
            , e = this.x + f - d * f + c * g
            , f = this.y + g - d * g - c * f;
        this.F && (e += this.F * (Math.random() - .5),
            f += this.F * (Math.random() - .5));
        0 > this.k && (e += a);
        0 > this.o && (f += b);
        var g = this.U / b
            , h = this.V / a;
    ...
    var db = []
        ...
        , lb = function (a) {
            fb = A;
            gb = a || null;
            window.addEventListener && (window.addEventListener("MozGamepadConnected", jb, !1),
                window.addEventListener("MozGamepadDisconnected", kb, !1));
            !navigator.webkitGamepads && !navigator.webkitGetGamepads || hb || (hb = !0,
                ib())
        };
    var mb = function (a, b) {
                ...
                var d = function () {
                    ...
                    , e = function () {
                        ...
                        a && "hidden" != a.style.visibility && (a = google.msg && google.msg.listen,
                            google.na && google.na.q && a && (a(106, d),
                                c && a(94, c)))
                    };
                e();
                google.doodle && google.doodle.jesr || (ia("google.doodle.jesr", !0),
    ...
    var Kb = "closure_lm_" + (1E6 * Math.random() | 0)
        ...
        , Nb = function (a, b, c, d, e) {
            ...
            if (a && a[Ab])
                ...
                c.i || (d = Qb(),
                    ...
                    d.src = a,
                    d.I = c,
                    a.addEventListener ? a.addEventListener(b.toString(), d, f) : a.attachEvent(Rb(b.toString()), d),
                    Mb++);
                a = c
            }
            return a
        ...
        , Tb = function (a, b, c, d, e) {
            if ("array" == ba(b))
                ...
                c = Ob(c),
                    a && a[Ab] ? a.unlisten(b, c, d, e) : a && (a = Pb(a)) && (b = Jb(a, b, c, !!d, e)) && Ub(b)
        }
        , Ub = function (a) {
    ...
    F.prototype.unlisten = function (a, b, c, d, e) {
        if ("array" == ba(b))
            ...
            c = c || this.handleEvent,
                ...
                c = Ob(c),
                d = !!d,
                b = a && a[Ab] ? Jb(a.G, String(b), c, d, e) : a ? (a = Pb(a)) ? Jb(a, b, c, d, e) : null : null,
                b && (Ub(b),
                    delete this.s[b.ha]);
        return this
    }
    ...
    var fc = function (a, b, c, d, e) {
        ...
        this.F = c;
        this.C = d;
        e && (this.p && this.unlisten(this.p, "action", this.w),
            e && (this.p = new ac(e),
                a = ga(zb, this.p),
                this.o ? a.call(void 0) : (this.k || (this.k = []),
                    this.k.push(a)),
    ...
    fc.prototype.H = function () {
        gc() && -1 == l.indexOf("Trident") && -1 == l.indexOf("MSIE") && window.gapi && window.gapi.load ? (window.gapi.load("share", ea(this.A, this)),
            Oa("gplus,li")) : (window.open("https://plus.google.com/share?url=" + this.D),
                Oa("gplus,lo"))
    }
        ;
    var gc = function () {
    ...
    fc.prototype.A = function () {
        ...
        ;
    var hc, ic, A, jc, kc, lc, G, mc, nc, oc, pc, qc, rc, sc, tc, uc, vc, wc, xc, H, yc, zc, Ac, I, Bc, J, Fa = [32, 13], Cc = [], Dc = 0, Ec = !1, Fc = 0, Gc = [], Hc = !0, Ic = function () {
        ...
        var b = p("img");
        b.src = "/logos/2012/" + a;
        rc && (b.complete || "complete" == b.readyState ? sc || (sc = window.setTimeout(Yc, 10)) : (b.onload = Zc,
            Dc++));
        return b
    }, K = function () {
        var a = ha()
            , b = a - nc;
        Ec ? (Cc.push(b),
            30 < Cc.length && Cc.shift()) : Cc = [];
        b = Math.min(40, b);
        yc || oc && 18E4 < a - oc ? Ec = !1 : !Hc && jc(a, b) ? (window.requestAnimationFrame ? window.requestAnimationFrame(K, A) : window.oRequestAnimationFrame ? window.oRequestAnimationFrame(K) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(K) : window.msRequestAnimationFrame ? window.msRequestAnimationFrame(K) : window.webkitRequestAnimationFrame ? window.webkitRequestAnimationFrame(K, A) : window.setTimeout(K, 16),
            nc = a,
            Ec = !0) : Ec = !1
    }, Sc = function (a, b, c) {
    ...
    var gd = [[640, 107, 304, 144], [3382, 266, 71, 70], [3145, 0, 71, 70], [23, 266, 530, 207], [556, 266, 530, 207], [1089, 369, 2260, 112], [1254, 107, 2268, 156], [0, 0, 3072, 104], [1089, 266, 1230, 100], [0, 107, 637, 44], [0, 184, 470, 44], [0, 154, 275, 27], [3352, 266, 27, 26], [3075, 0, 67, 69], [947, 107, 304, 144], [0, 266, 20, 23], [3525, 0, 16, 16]];
        ...
        null == Y && (2 == L ? (W = Pd,
            Y = Od) : 5 == L ? 0 < M ? (W = Td,
                Y = Sd) : (W = Vd,
                    Y = Ud) : Xd ? (W = Nd,
                        Y = Md) : N[2] && 150 <= X ? (W = Pd,
                            Y = Od) : (N[2] && 150 <= X ? 0 : N[3] && 390 >= X) ? (W = Rd,
                                Y = Qd) : (W = Pd,
                                    W.frame = 0),
            Y && Y.play())
    };
    var ce = {
        ...
        de: ["Rekord", "Fu\u00dfball", "Ich habe Fu\u00dfball gespielt #GoogleDoodle"],
        ...
        es: ["R\u00e9cord", "F\u00fatbol", "He jugado al f\u00fatbol #GoogleDoodle"],
        ...
        ja: ["\u30b9\u30b3\u30a2", "\u30b5\u30c3\u30ab\u30fc", "\u300c\u30b5\u30c3\u30ab\u30fc\u300d\u3092\u3084\u3063\u305f! #GoogleDoodle"],
        ...
        pl: ["Najlepszy wynik", "Pi\u0142ka no\u017cna", "Gram w pi\u0142k\u0119 no\u017cn\u0105 #GoogleDoodle"],
        ...
        sl: ["Najbolj\u0161i rezultat", "Nogomet", "Igral sem nogomet #GoogleDoodle"],
        ...
        th_All: ["\u0e04\u0e30\u0e41\u0e19\u0e19\u0e2a\u0e39\u0e07\u0e2a\u0e38\u0e14", "\u0e1f\u0e38\u0e15\u0e1a\u0e2d\u0e25 ", "\u0e09\u0e31\u0e19\u0e40\u0e15\u0e30\u0e1f\u0e38\u0e15\u0e1a\u0e2d\u0e25\u0e1a\u0e19 Google Doodle!"],
        ...
        "zh-TW_HK": ["\u6700\u9ad8\u5f97\u5206", "\u8db3\u7403", "\u6211\u8e22\u4e86\u5834\u8db3\u7403\uff01 #GoogleDoodle"],
    ...
    var Z = []
        ...
        , Vc = function (a, b) {
            ...
            for (var d = X, e = 0, f; f = jd[e++];) {
                ...
                g.x += k;
                g.y += t;
                0 > g.height ? (g.height = 0,
                    g.i = .1 > Math.abs(g.i) ? 0 : g.i = .6 * -g.i) : 0 < g.height && (g.i -= g.w * h);
                2 == f.state && 50 >= f.y && (f.state = 0);
                1 == f.state && 191 <= f.y && (w(f.k),
                    50 < Math.abs(f.x - d) || f.A && !Xd || !f.A && Xd ? (f.state = 3,
                        id++) : (f.state = 2,
                            M++,
    ...
    (function (a, b, c) {
        ...
        if (Xc()) {
            ...
            Ad = new rb("/logos/2012/soccer12-hp-sprite.png", gd);
            Ha = Ic();
            kd = Ha.getContext("2d");
            wd = Mc();
            Tc();
            for (var a = 0; 9 >= a; a++)
                Z[a] = V(11, 25 * a, 0, 25, 27);
            sd = V(11, 250, 0, 25, 27);
            Q = V(13, 0, 0, 67, 69);
